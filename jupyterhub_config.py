...
# c.JupyterHub.data_files_path = '/home/cristisch/venvs/jupyterhub/jupyterhub/share/jupyter/hub'
...
c.JupyterHub.hub_ip = '192.168.13.24'
...
c.Authenticator.login_service = 'Kerberos'
...
c.PAMAuthenticator.login_service = 'Kerberos'
